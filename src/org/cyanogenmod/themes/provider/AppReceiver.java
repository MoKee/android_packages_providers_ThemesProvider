...
public class AppReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        try {
            ...
            } else if (mokee.content.Intent.ACTION_THEME_RESOURCES_CACHED.equals(action)) {
                final String themePkgName = intent.getStringExtra(mokee.content.Intent.EXTRA_THEME_PACKAGE_NAME);
                final int result = intent.getIntExtra(mokee.content.Intent.EXTRA_THEME_RESULT,
